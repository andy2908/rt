...
@XmlRootElement(name = "HEGICMotorRenewal_GetRenewalPlans")
public class HEGICMotorRenewalGetRenewalPlans {

    @XmlElement(name = "AgentCode")
    protected String agentCode;
    @XmlElement(name = "PrevPolicyNo")
    protected String prevPolicyNo;
    @XmlElement(name = "VehicleRegistrationNo")
    protected String vehicleRegistrationNo;
     ...
     *     
     */
    public void setVehicleRegistrationNo(String value) {
