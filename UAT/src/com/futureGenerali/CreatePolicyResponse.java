...
public class CreatePolicyResponse {
    ...
    protected JAXBElement<String> createPolicyResult;
     ...
     *     
     */
    public JAXBElement<String> getCreatePolicyResult() {
     ...
     *     
     */
    public void setCreatePolicyResult(JAXBElement<String> value) {
