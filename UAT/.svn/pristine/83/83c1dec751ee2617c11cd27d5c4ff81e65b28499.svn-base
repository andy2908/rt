 ...
 * 
 */
@WebServiceClient(name = "Service1", targetNamespace = "http://tempuri.org/", wsdlLocation = "http://14.141.41.53:800/WebAggWCFUAT/Service1.svc?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://14.141.41.53:800/WebAggWCFUAT/Service1.svc?wsdl");
