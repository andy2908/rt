...
public class MasterController {
	...
	public @ResponseBody String getFindFormData(HttpServletRequest request,
		...
		String modelType = request.getParameter("str_modelType");
		...
		String result = masterDao.getInsFindFormList(pkg_name, proc_name,
				...
				str_calctype, str_fuelkit, str_custType, valID,modelType);
		/*
		 * try { PrintWriter writer = res.getWriter(); writer.write(result);
		 * writer.flush(); writer.close(); } catch (IOException e) { // TODO
		 * Auto-generated catch block e.printStackTrace(); }
...
//                PO_ERROR    Out Varchar2)
	...
	@RequestMapping(value = "/user/startLoading", method = RequestMethod.POST, produces = "application/json; charset=UTF-8")
	public @ResponseBody String startLoading(HttpServletRequest request, HttpServletResponse res) {
	...
	@RequestMapping(value = "/user/stopLoading", method = RequestMethod.POST, produces = "application/json; charset=UTF-8")
	public @ResponseBody String stopLoading(HttpServletRequest request, HttpServletResponse res) {
