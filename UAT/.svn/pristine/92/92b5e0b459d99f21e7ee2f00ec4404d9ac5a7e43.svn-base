 ...
 *         &lt;element name="VehicleClassCode" type="{http://www.w3.org/2001/XMLSchema}int"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "getPremiumMultiYear")
public class GetPremiumMultiYear {

    protected String str;
    @XmlElement(name = "VehicleClassCode")
    protected int vehicleClassCode;
     ...
     * 
     */
    public void setVehicleClassCode(int value) {
