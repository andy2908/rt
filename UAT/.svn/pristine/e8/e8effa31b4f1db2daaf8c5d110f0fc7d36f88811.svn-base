 ...
 * 
 */
@WebServiceClient(name = "Service", targetNamespace = "http://tempuri.org/", wsdlLocation = "http://fglpg001.futuregenerali.in/BO/Service.svc?singleWsdl")
    ...
    extends javax.xml.ws.Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://fglpg001.futuregenerali.in/BO/Service.svc?singleWsdl");
