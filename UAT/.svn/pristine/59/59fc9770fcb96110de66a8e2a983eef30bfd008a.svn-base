...
@Repository
public class IntegrationUniversalDao {
	...
	public String getUniversalData(String pkg_name, String proc_name,HashMap inputParaList) {
		...
		while (resItr.hasNext()) {
			...
			if (getKey.equalsIgnoreCase("po_error")) {
				retMsg = (null == me.getValue()) ? "" : me.getValue()
						.toString();
				System.out.println("Universal Dao Error----->>"+retMsg);
			}
...
//				System.out.println("jsonNames universal Dao------>>>>"+jsonNames);
			}
