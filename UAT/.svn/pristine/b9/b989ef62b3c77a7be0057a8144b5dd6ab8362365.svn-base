 ...
 * 
 */
@WebServiceClient(name = "Service", targetNamespace = "http://tempuri.org/", wsdlLocation = "http://202.191.196.210/uat/onlineproducts/newmotorcp/service.asmx?WSDL")
    ...
    extends javax.xml.ws.Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://202.191.196.210/uat/onlineproducts/newmotorcp/service.asmx?WSDL");
