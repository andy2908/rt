 ...
 * 
 */
@WebServiceClient(name = "WebServiceImplService", targetNamespace = "http://bajaj.com/", wsdlLocation = "http://webservicesdev.bajajallianz.com/docDownldWS/WebServiceImplService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEBSERVICEIMPLSERVICE_QNAME = new QName("http://bajaj.com/", "WebServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://webservicesdev.bajajallianz.com/docDownldWS/WebServiceImplService?wsdl");
    ...
    public WebServiceInterface getWebServiceImplPort() {
        return super.getPort(new QName("http://bajaj.com/", "WebServiceImplPort"), WebServiceInterface.class);
    }
    ...
    public WebServiceInterface getWebServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://bajaj.com/", "WebServiceImplPort"), WebServiceInterface.class, features);
    }
