...
public final class UsernameGenerator {
    ...
    private UsernameGenerator(UsernameGeneratorBuilder builder) {
    ...
    public static class UsernameGeneratorBuilder {
        ...
        public UsernameGeneratorBuilder() {
            this.useLower = false;
            this.useUpper = false;
         ...
         */
        public UsernameGeneratorBuilder useLower(boolean useLower) {
         ...
         * @return the builder for chaining.
         */
        public UsernameGeneratorBuilder useUpper(boolean useUpper) {
         ...
         * @return the builder for chaining.
         */
        public UsernameGeneratorBuilder useDigits(boolean useDigits) {
         ...
         * @return the builder for chaining.
         */
        public UsernameGeneratorBuilder usePunctuation(boolean usePunctuation) {
         ...
         * object.
         */
        public UsernameGenerator build() {
